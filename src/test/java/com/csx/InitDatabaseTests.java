...
import com.csx.service.SensitiveService;
...
public class InitDatabaseTests {
    ...
    public void contextLoads() {
        ...
        for (int i = 0; i < 11; ++i) {
            User user = new User();
            user.setHeadUrl(String.format("http://images.csx.com/head/%dt.png", random.nextInt(1000)));
        ...
        //Assert.assertNull(userDAO.getTopicById(1));
    }
