...
public class LikeController {
    ...
    public String like(@RequestParam("commentId") int commentId) {
        ...
        long likeCount = likeService.like(hostHolder.getUser().getId(), EntityType.ENTITY_COMMENT, commentId,comment.getEntityId());
    ...
    public String dislike(@RequestParam("commentId") int commentId) {
        ...
        long likeCount = likeService.disLike(hostHolder.getUser().getId(), EntityType.ENTITY_COMMENT, commentId,comment.getEntityId());
        return WendaUtil.getJSONString(0, String.valueOf(likeCount));
    }
}
