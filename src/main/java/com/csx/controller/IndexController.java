...
import com.csx.service.WendaService;
...
public class IndexController {
    ...
    public String request(Model model, HttpServletResponse response,
        ...
        response.addCookie(new Cookie("username", "csx"));
    ...
    public ModelAndView error(Exception e) {
        ...
        modelAndView.addObject("message", e.getMessage());//对应error.jsp中的${errorMessage}标签
        return modelAndView;
    }
}
